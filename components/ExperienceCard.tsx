...
const ExperienceCard = (props: Props) => {
  return (
    <article className="mt-10 flex flex-col rounded-lg items-center space-y-7 flex-shrink-0 w-[300px] md:w-[400px] xl:h-[410px] snap-center p-7 bg-[#292929] cursor-pointer transition-opacity duration-200 overflow-hidden">
      <motion.img
      ...
      <div className="px-0 md:px-10">
        <h4 className="text-4xl font-light text-g">Aulab</h4>
